...
For more clarity:
Brach main:					Branch A:
function awesome()			function awesome()
{							{				
...
h5. some differences between rsync and csync2
...
refernce links : http://oss.linbit.com/csync2/paper.pdf
